...
namespace FastShooter
{
    public class Bullet2 : Entity
    {
        ...
        public Bullet2(Vector2 position, float speed, GameTags playerTag)
            :base(position)
        {
            BulletDamage = 6;
            ...
            {
                bullet = Engine.Instance.Content.Load<Texture2D>("Bullet2-1");
            ...
            {
                bullet = Engine.Instance.Content.Load<Texture2D>("Bullet2-2");
                bulletAnimation = new AnimationData(bullet, 100, 21, false);
            ...
            this.Tag((int)GameTags.Bullet2);
            this.Collider = new Hitbox(10, 10, 0.0f, 0.0f);
